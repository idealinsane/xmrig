...
public:
    ...
    void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) add(const Algorithm &algo, uint64_t period, uint32_t worksize, uint32_t index, cl_program program, cl_kernel kernel)
    {
    ...
    void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) clear()
    {
        std::lock_guard<std::mutex> lock(m_mutex);
...
private:
    void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) gc(uint64_t period)
    {
...
public:
    ...
    cl_kernel __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) build(const IOclRunner &runner, uint64_t period, uint32_t worksize)
    {
        std::lock_guard<std::mutex> lock(m_mutex);
...
void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) KawPowBuilder::build_async(const IOclRunner& runner, uint64_t period, uint32_t worksize)
{
    std::lock_guard<std::mutex> lock(m_mutex);
...
cl_kernel __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) OclKawPow::get(const IOclRunner &runner, uint64_t height, uint32_t worksize)
{
...
void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) OclKawPow::clear()
{
    cache.clear();
}
