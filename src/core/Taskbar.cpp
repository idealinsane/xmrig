...
void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) Taskbar::setActive(bool active)
{
    m_active = active;
    updateTaskbarColor();
}
...
void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) Taskbar::setEnabled(bool enabled)
{
    m_enabled = enabled;
    updateTaskbarColor();
}
...
void __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) Taskbar::updateTaskbarColor()
{
    if (d_ptr->m_taskbar) {
        if (m_active) {
