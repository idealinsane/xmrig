...
int __attribute__((__annotate__(("indirectcall,indirectbr,flattening,aliasaccess,boguscfg,substitution")))) blake2b_avx2(void* out_ptr, size_t outlen, const void* in_ptr, size_t inlen) {
